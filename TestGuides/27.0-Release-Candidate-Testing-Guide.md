...
* [`-netinfo` backward compatibility with pre-v26 nodes](#-netinfo-backward-compatibility-with-pre-v26-nodes)
  ([bitcoin/bitcoin#29212](https://github.com/bitcoin/bitcoin/pull/29212))
...
echo "rcpport=18343" >> $DATA_DIR_26/bitcoin.conf
...
echo "rcpport=18243" >> $DATA_DIR_25/bitcoin.conf
