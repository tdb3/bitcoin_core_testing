...
Create our first transaction from the unspent coinbase transaction, leaving a few sats on
the table for the fee.
```bash
...
```
Create a child transaction spending the second output (`"n": 1`) of 48.999 BTC:
```bash
...
```
```bash
v3_parent_raw_tx="0300000001d82124d86353b610a53b19779ae71c29877b042c6db6c559e8d3aa622f5ef7ff0000000000fdffffff0200e1f50500000000160014623affcf6334d7e50a9757b80f702e4129aa02d0608a0e24010000001600146b458f0507bc79e85774bb2db7e820adb557e95800000000"
```

Sign the v3 transaction:

```bash
v3_parent_signed_tx_result=$(bcli signrawtransactionwithwallet $v3_parent_raw_tx)
...
v3_child_raw_tx=$(bcli createrawtransaction "[{\"txid\": \"$v3_parent_txid\", \"vout\": 1}]" "[{\"$ADDRESS_B\": 1},{\"$ADDRESS_A\": 47.998}]")
echo $v3_child_raw_tx
```
```bash
...
```
Tweak the version again:
```bash
v3_child_raw_tx="030000000184ee5e9554ddc17effa84941e4034dc5e1878595a550f40ab8ef8159390338890100000000fdffffff0200e1f50500000000160014623affcf6334d7e50a9757b80f702e4129aa02d0c022171e010000001600146b458f0507bc79e85774bb2db7e820adb557e95800000000"
```
And sign:
```bash
v3_child_signed_tx_result=$(bcli signrawtransactionwithwallet $v3_child_raw_tx "[{\"txid\":\"$v3_parent_txid\", \"vout\": 1, \"scriptPubKey\": \"$v3_parent_spk\", \"witnessScript\": \"$v3_parent_witness_script\", \"amount\": 48.999}]")
...
v3_grandchild_raw_tx=$(bcli createrawtransaction "[{\"txid\": \"$v3_child_txid\", \"vout\": 1}]" "[{\"$ADDRESS_B\": 1},{\"$ADDRESS_A\": 46.997}]")
echo $v3_grandchild_raw_tx
```
```bash
...
Tweak version:
```bash
v3_grandchild_raw_tx="0300000001d86344dab2eea0e3209169fd3c578bef2479f79b68e564c1637d32cfee8938860100000000fdffffff0200e1f50500000000160014623affcf6334d7e50a9757b80f702e4129aa02d020bb1f18010000001600146b458f0507bc79e85774bb2db7e820adb557e95800000000"
```

And sign:
```bash
v3_grandchild_signed_tx_result=$(bcli signrawtransactionwithwallet $v3_grandchild_raw_tx "[{\"txid\":\"$v3_child_txid\", \"vout\": 1, \"scriptPubKey\": \"$v3_child_spk\", \"witnessScript\": \"$v3_child_witness_script\", \"amount\": 47.998}]")
...
```bash
high_fee_child_raw_tx=$(bcli createrawtransaction "[{\"txid\": \"$v3_parent_txid\", \"vout\": 1}]" "[{\"$ADDRESS_B\": 1},{\"$ADDRESS_A\": 47.997}]")
echo $high_fee_child_raw_tx
```
```bash
...
Tweak to v3:
```bash
high_fee_child_raw_tx="0300000001d86344dab2eea0e3209169fd3c578bef2479f79b68e564c1637d32cfee8938860100000000fdffffff0200e1f50500000000160014623affcf6334d7e50a9757b80f702e4129aa02d020bb1f18010000001600146b458f0507bc79e85774bb2db7e820adb557e95800000000"
```
And sign:
```bash
high_fee_child_signed_tx_result=$(bcli signrawtransactionwithwallet $high_fee_child_raw "[{\"txid\":\"$v3_parent_txid\", \"vout\": 1, \"scriptPubKey\": \"$v3_parent_spk\", \"witnessScript\": \"$v3_parent_witness_script\", \"amount\": 48.999}]")
high_fee_child_signed_tx=$(echo $high_fee_child_signed_result | jq -r .hex)
