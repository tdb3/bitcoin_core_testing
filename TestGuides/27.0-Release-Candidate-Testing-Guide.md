...
> ☝ Legacy wallets allow for addresses private keys and watch-only addresses to mix together because it used
...
> ☝ The solvables wallet can update a PSBT with the UTXO, scripts, and pubkeys, for inputs
