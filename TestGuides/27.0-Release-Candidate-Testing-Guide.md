...
* [NAME OF PR](#LINK_TO_HEADING) ([PR](https://github.com/bitcoin/bitcoin/pull/NUMBER))
...
TODO: RATHER THAN CREATING A bitcoin.conf, CONSIDER USING CLI
```shell
bitcoind-test
```
